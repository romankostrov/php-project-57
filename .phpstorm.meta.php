...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.date_format_javascript' => 'string',
            ...
            'filesystems.links./home/roman/Documents/Projects/php-project-57/public/storage' => 'string',
...
'app.aliases.Vite','app.date_format','app.date_format_javascript','auth.defaults.guard','auth.defaults.passwords',
...
'filesystems.links./home/roman/Documents/Projects/php-project-57/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'session.same_site','session.partitioned','view.paths','view.compiled','cors.paths',
...
'concurrency.default','query-builder.parameters.include','query-builder.parameters.filter','query-builder.parameters.sort','query-builder.parameters.fields',
...
'dusk.login','dusk.logout','dusk.user','dashboard',
'profile.edit','profile.update','profile.destroy','status.index','status.build',
'status.create','task_statuses.show','status.edit','status.update','status.destroy',
'task.index','task.build','task.create','task.show','task.edit',
'task.update','task.destroy','label.index','label.build','label.create',
'label.show','label.edit','label.update','label.destroy','register','login','password.request','password.email',
...
'label.create','label.edit','label.index','layouts.app','layouts.guest',
...
'task.create','task.edit','task.index','task.show','task_status.create',
'task_status.edit','task_status.index','welcome','flash::message','flash::modal',
...
'auth.failed','auth.password','auth.throttle','auth.email','auth.remember',
'auth.forgot','auth.login','auth.confirm','auth.already','auth.register',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','label.labels',
'label.createLabel','label.label','label.id','label.name','label.description',
'label.dateCreation','label.actions','label.delete','label.edit','label.editLabel',
'label.update','label.flashCreate','label.flashChange','label.flashNotDelete','label.flashDelete',
'label.create','other.password','other.logo','other.push','other.body',
'other.greeting','other.confirmation','other.exit','other.login','other.registration',
'other.tasks','other.statuses','other.tags','task.name','task.createStatus',
'task.create','task.editTask','task.update','task.id','task.dateCreation',
'task.actions','task.statuses','task.delete','task.edit','task.status',
'task.author','task.executor','task.dateCreate','task.tasks','task.task',
'task.apply','task.createTask','task.description','task.tags','task.view',
'task.flashCreate','task.flashChange','task.flashDelete','task_status.name','task_status.createStatus',
'task_status.create','task_status.editStatus','task_status.update','task_status.id','task_status.dateCreation',
'task_status.actions','task_status.statuses','task_status.delete','task_status.edit','task_status.status',
'task_status.flashCreate','task_status.flashChange','task_status.flashNotDelete','task_status.flashDelete','validation.attributes.0',);
